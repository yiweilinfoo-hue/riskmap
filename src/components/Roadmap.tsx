      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="bg-[#fde8e8] rounded-lg p-4 shadow-sm border border-red-100 flex items-center gap-4 min-w-[200px] relative overflow-hidden">
          ...
          <div className="flex flex-col z-10">
            ...
            <span className="text-sm text-red-800 font-medium">线上风险</span>
          </div>
              ...
              >
                ...
                <div className="flex-1 flex flex-col gap-1 relative">
                  <div className="flex items-center gap-2">
                    ...
                    {exceptions > 0 && (
                      <span className="ml-auto inline-flex items-center gap-1 text-xs font-semibold text-red-600 bg-red-50 px-1.5 py-0.5 rounded border border-red-100 ">
                        <AlertTriangle size={10} /> {exceptions} 项风险
                      </span>
                    )}
        ...
        <div className="hidden lg:block relative bg-slate-50/50 rounded-2xl pt-12 pb-6 px-6 border border-slate-200 mt-6">
          ...
          <div className="grid grid-cols-6 gap-0 relative pt-20 pb-4">
            ...
            {nodeIndex !== -1 && (
              ...
              >
                {/* Visual bubble */}
                <div className="bg-blue-600 text-white text-xs font-bold px-2.5 py-0.5 rounded-full shadow-md flex items-center gap-1 border border-blue-400/20 whitespace-nowrap ">
                  <CheckCircle size={10} />
                  <span>当前环节</span>
                </div>
                {/* Pointer */}
                  ...
                  {exceptions > 0 && (() => {
                    ...
                    return (
                      <div className="absolute -top-11 z-30 flex flex-col items-center">
                        <div 
                          className={`relative whitespace-nowrap bg-[#fde8e8] text-red-600 border border-red-200 text-xs px-2.5 py-1.5 rounded-md flex items-center shadow-sm font-semibold cursor-pointer hover:bg-red-100 transition-colors ${!isExpanded ? '' : ''}`}
                          onClick={(e) => {
                            e.stopPropagation();
                          ...
                          {isExpanded && (
                            ...
                            >
                              <div className="bg-red-50 px-3 py-2 border-b border-red-100 font-bold text-slate-800 flex justify-between items-center">
                                <span className="text-xs">风险事项明细</span>
                              </div>
